...
import { PresentationSubmission, W3CVerifiablePresentation, WrappedVerifiablePresentation } from '@sphereon/ssi-types';
...
export declare const extractPresentationsFromAuthorizationResponse: (response: AuthorizationResponse) => Promise<WrappedVerifiablePresentation[]>;
